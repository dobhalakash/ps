...
export class HomeComponent implements OnInit, OnDestroy {
  ...
  catCircles = [ 
    { label: 'Cricket',     icon: 'fa-solid fa-baseball', path: '/products', params: { category: 'cricket' } }, 
    { label: 'Football',    icon: 'fa-solid fa-futbol',            path: '/products', params: { category: 'Kashmir%20Willow' } },
